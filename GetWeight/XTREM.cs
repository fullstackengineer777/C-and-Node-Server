        ...
        private async void Listen_UDP_Async()
        {
            ...
            while (!StopThread)
            {
                try
                {
                    ...
                    rx_buffer = "34000g01110f123456789012345e1234567890";
            ...
            try
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        /* sent udp above and now read udp datagram */   
                        /* send udp datagram at most 5 times until a new datagram has arrived */
                        while (data.Length == 0)
                        {
